...
import secrets
from gallery.models import Project, ProjectEvents
from management.models import Billing, Payments
...
class QuickStripe:
	...
	def slug_string_construction(self, slug):
		...
		if len(str(slug)) > 16:
			model_object_slug = 'terms' + str(slug[0:17]) + hex_gen_small()
		else:
			model_object_slug = 'terms' + str(slug) + hex_gen_small()
